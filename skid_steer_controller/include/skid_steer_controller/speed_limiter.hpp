...
class SpeedLimiter
{
  public:
     ...
     */
    [[deprecated]] explicit SpeedLimiter(bool has_velocity_limits = true, bool has_acceleration_limits = true,
                                         ...
                                         double max_jerk = std::numeric_limits<double>::quiet_NaN())
    {
        ...
        speed_limiter_ = control_toolbox::RateLimiter<double>(
            min_velocity, max_velocity, max_deceleration, max_acceleration, std::numeric_limits<double>::quiet_NaN(),
            std::numeric_limits<double>::quiet_NaN(), min_jerk, max_jerk);
    }
     ...
     */
    explicit SpeedLimiter(double min_velocity, double max_velocity, double max_acceleration_reverse,
                          double max_acceleration, double max_deceleration, double max_deceleration_reverse,
                          double min_jerk, double max_jerk)
    {
        speed_limiter_ =
            control_toolbox::RateLimiter<double>(min_velocity, max_velocity, max_acceleration_reverse, max_acceleration,
                                                 max_deceleration, max_deceleration_reverse, min_jerk, max_jerk);
    }
    ...
    {
        return speed_limiter_.limit_value(v);
    }
