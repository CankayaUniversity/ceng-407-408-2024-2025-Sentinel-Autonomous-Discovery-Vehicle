 ...
 *
 */
#ifndef GZ_SIM_SYSTEMS_GazeboRosSkidSteerDrive_HH_
#define GZ_SIM_SYSTEMS_GazeboRosSkidSteerDrive_HH_
...
{
  // Forward declaration
  class GazeboRosSkidSteerDrivePrivate;
  ...
  {
    /// \brief Constructor
    public: GazeboRosSkidSteerDrive();

    /// \brief Destructor
    public: ~GazeboRosSkidSteerDrive() override = default;
    ...
    private: std::unique_ptr<GazeboRosSkidSteerDrivePrivate> dataPtr;
  };
  }
}
}
